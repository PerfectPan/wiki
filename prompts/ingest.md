...
1. **提取核心论点**：文章主要在说什么？
2. **识别关键概念**：有哪些新概念、术语、方法论？
3. **梳理结构**：文章的论证结构是什么？
4. **判断价值**：哪些内容值得沉淀到 wiki？

### GitHub 仓库

1. **理解项目**：这是什么项目？解决什么问题？
2. **识别技术栈**：从 package.json/Cargo.toml 等判断用了什么框架和语言
3. **分析架构**：目录结构反映了什么设计模式？核心模块有哪些？
4. **提取关键设计**：有哪些值得记录的设计决策、架构模式？
