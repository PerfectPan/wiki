...
- 光谱按光的波长铺开，人眼可见的大概在 400nm - 700nm，也被称为可见光
	- ![CleanShot 2023-06-17 at 17.05.43@2x.png](../assets/CleanShot_2023-06-17_at_17.05.43@2x_1686992758667_0.png)
...
- 视网膜上有许多感光细胞
	...
	- 视锥细胞能感知[[颜色]]，又被分为三类，分别为 S M 和 L，分别对应在响应曲线上最大响应对应的波长，数量很少（对应红绿蓝三种光线）
		- ![CleanShot 2023-06-17 at 17.10.32@2x.png](../assets/CleanShot_2023-06-17_at_17.10.32@2x_1686993043500_0.png)
	...
	- 对于一种类型的光线，它有不同的 SPD，人类能看到不同的 S M L，人类看不到感受不到光谱
		- ![CleanShot 2023-06-17 at 17.30.40@2x.png](../assets/CleanShot_2023-06-17_at_17.30.40@2x_1686994272959_0.png)
...
- 加色系统（适用于光源 / 发光体）
  collapsed:: true
	- 给定三种基本光，这三个光对应的光谱是一个单峰值函数，以它们为基本向量空间中的分量，然后调整系数 R G B （代表对应光线的强度）来混合出（线性组合出）不一样的颜色即所谓的 RGB
		...
		- ![CleanShot 2023-06-17 at 19.34.01@2x.png](../assets/CleanShot_2023-06-17_at_19.34.01@2x_1687001650389_0.png)
	- 给定一个混色光的光谱，通过积分确定最后的值
		- ![CleanShot 2023-06-17 at 19.34.17@2x.png](../assets/CleanShot_2023-06-17_at_19.34.17@2x_1687001669418_0.png)
	- 加色系统中光线混合会越来越来亮，趋近于白色
- 色彩空间：（我理解就是怎么表示一个颜色，然后这个空间是有限的）
	- sRGB 很流行
	- 不同于上面 RGB 是通过实验得出的，CIE XYZ 是自己造了三个原色，都为正，能表示尽可能多的颜色（CIE RGB 的线性变换）
		- ![CleanShot 2023-06-17 at 20.19.02@2x.png](../assets/CleanShot_2023-06-17_at_20.19.02@2x_1687004355228_0.png)
		...
		- ![CleanShot 2023-06-17 at 21.57.28@2x.png](../assets/CleanShot_2023-06-17_at_21.57.28@2x_1687010263155_0.png)
		- ![CleanShot 2023-06-17 at 20.19.35@2x.png](../assets/CleanShot_2023-06-17_at_20.19.35@2x_1687004387174_0.png)
	- 其他更友好的色彩空间：
		- HSV
			- ![CleanShot 2023-06-17 at 20.21.46@2x.png](../assets/CleanShot_2023-06-17_at_20.21.46@2x_1687004514565_0.png)
...
- 减色系统（反光体）：CMYK，减色系统是越混越黑的（不懂），特意有个黑色主要是因为减色系统通常用在打印，然后黑色的墨水会比各种颜色混起来成黑色成本更低，又因为打印黑色墨水用的频率会很高，所以会单独列出来
  collapsed:: true
	- ![CleanShot 2023-06-17 at 23.22.30@2x.png](../assets/CleanShot_2023-06-17_at_23.22.30@2x_1687015360724_0.png)
