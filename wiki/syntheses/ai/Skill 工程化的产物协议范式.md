...
它说明：即使没有完整 control plane，**先把可消费产物契约和反默认失败写死**，Skill 已经从 prompt 包装升到可收录的工程组件。收录索引见 [[Awesome Agent Skills]]；评审事实见 `raw/sources/2026-08-06-bento-slides-skill-review.md`。
