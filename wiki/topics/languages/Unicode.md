...
- https://tonsky.me/blog/unicode/
	...
	- utf-8 utf-16 是编码 unicode 的规范，最简单的是 utf-32，直接用 32 位存储，也就是 4 个字节，但是会有很多的浪费，前者是变长的编码
		- ![CleanShot 2023-11-08 at 18.01.42.png](../../../raw/assets/CleanShot_2023-11-08_at_18.01.42_1699437711987_0.png)
	...
	- 更离谱的是长的一样的字符可能是由不同的 unicode 组合而成的
		- ```js
		  ...
		  "Å" === "Å"
		  ```
		- ![CleanShot 2023-11-08 at 20.59.46@2x.png](../../../raw/assets/CleanShot_2023-11-08_at_20.59.46@2x_1699448397774_0.png)
	- unicode 同时是地域不同的，也就是说同一个 code Point，不同的地区渲染的结果会不一样
		- ![CleanShot 2023-11-08 at 21.01.14@2x.png](../../../raw/assets/CleanShot_2023-11-08_at_21.01.14@2x_1699448483871_0.png)
...
- UTF-16 是 UCS-2 的延伸，UCS-2 是基于只有 65535（FFFF）个字符的前提下把每个字符都用 2 个字节表示的编码形式，但是现在 Unicode 的空间已经从 U+00 0000 - U+10FFFF 了。
	...
	- ![CleanShot 2023-11-08 at 21.37.56@2x.png](../../../raw/assets/CleanShot_2023-11-08_at_21.37.56@2x_1699450686448_0.png)
