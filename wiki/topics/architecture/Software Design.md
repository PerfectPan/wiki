...
- 创建对象和对象使用应该分开，使用对象不应该关心对象是如何被创建出来的（使用依赖注入分离） [[Dependency Injection]]
	...
	- 在线文档需要更强大的依赖注入
		- 支持异步模块依赖
			- ![CleanShot 2025-03-30 at 13.51.55@2x.png](../../../raw/assets/CleanShot_2025-03-30_at_13.51.55@2x_1743313937222_0.png)
		- 支持容器化销毁和复用：保持内存在一个低水平线
		- 支持对象延迟初始化：异步加载以后等使用到的时候再初始化
		- 帮助构建单向依赖系统：创建多个容器，容器和容器可以分层依赖
		- ![CleanShot 2025-03-30 at 13.10.28@2x.png](../../../raw/assets/CleanShot_2025-03-30_at_13.10.28@2x_1743311442785_0.png)
		- 延迟初始化实现思路：
			- ![CleanShot 2025-03-30 at 13.23.08@2x.png](../../../raw/assets/CleanShot_2025-03-30_at_13.23.08@2x_1743312194556_0.png)
...
- ![CleanShot 2025-03-30 at 14.17.03@2x.png](../../../raw/assets/CleanShot_2025-03-30_at_14.17.03@2x_1743315439014_0.png)
